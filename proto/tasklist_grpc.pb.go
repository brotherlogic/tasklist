...
const (
	TaskListService_AddTaskList_FullMethodName       = "/tasklist.TaskListService/AddTaskList"
	TaskListService_GetTaskLists_FullMethodName      = "/tasklist.TaskListService/GetTaskLists"
	TaskListService_ValidateTaskLists_FullMethodName = "/tasklist.TaskListService/ValidateTaskLists"
	TaskListService_GetTasks_FullMethodName          = "/tasklist.TaskListService/GetTasks"
	TaskListService_RenameJob_FullMethodName         = "/tasklist.TaskListService/RenameJob"
)
...
func (c *taskListServiceClient) AddTaskList(ctx context.Context, in *AddTaskListRequest, opts ...grpc.CallOption) (*AddTaskListResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskListService_AddTaskList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskListServiceClient) GetTaskLists(ctx context.Context, in *GetTaskListsRequest, opts ...grpc.CallOption) (*GetTaskListsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskListService_GetTaskLists_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskListServiceClient) ValidateTaskLists(ctx context.Context, in *ValidateTaskListsRequest, opts ...grpc.CallOption) (*ValidateTaskListsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskListService_ValidateTaskLists_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskListServiceClient) GetTasks(ctx context.Context, in *GetTasksRequest, opts ...grpc.CallOption) (*GetTasksResponse, error) {
	out := new(GetTasksResponse)
	err := c.cc.Invoke(ctx, TaskListService_GetTasks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskListServiceClient) RenameJob(ctx context.Context, in *RenameJobRequest, opts ...grpc.CallOption) (*RenameJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskListService_RenameJob_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TaskListService_AddTaskList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskListService_AddTaskList_FullMethodName,
	}
...
func _TaskListService_GetTaskLists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskListService_GetTaskLists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskListService_ValidateTaskLists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskListService_ValidateTaskLists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskListService_GetTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTasksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskListServiceServer).GetTasks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskListService_GetTasks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskListServiceServer).GetTasks(ctx, req.(*GetTasksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TaskListService_RenameJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskListService_RenameJob_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
